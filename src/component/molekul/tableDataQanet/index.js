...
import "./tableDataQanet.css";
import { Tooltip, OverlayTrigger } from "react-bootstrap";

function tableDataQanet(props) {
  const { dataFromStore } = props;
      ...
      table.push(
        <tr key={dataList[index].id} id={dataList[index].id}>
          ...
          <td style={{ textAlign: "center" }}>
            ...
            >
              <TiDownload style={{ pointerEvents: "none" }} />
            </Button>{" "}
            <Button
              variant="primary"
              size="sm"
            ...
            >
              <VscPreview style={{ pointerEvents: "none" }} />
            </Button>
          </td>
        </tr>
      );
...
export default GlobalConsumer(tableDataQanet);
